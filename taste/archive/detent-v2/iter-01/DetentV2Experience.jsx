    ...
    <main className="rotary bg-surface text-ink">
      ...
      <div className="rotary__stage">
        ...
        >
          {speed > 0.02 && (
            <span
              className="rotary__needle rotary__needle--ghost"
              style={{
                "--rotary-mark-angle": `${knobAngle - trailSign * speed * TRAIL_MAX_DEG}deg`,
                opacity: speed * 0.35,
              }}
            >
          ...
          {speed > 0.5 && (
            <span
              className="rotary__needle rotary__needle--ghost"
              style={{
                "--rotary-mark-angle": `${knobAngle - trailSign * speed * TRAIL_MAX_DEG * 1.8}deg`,
                opacity: speed * 0.18,
              }}
            >
              <span className="rotary__knob-mark" />
          ...
          <span
            className="rotary__needle rotary__needle--settling"
            data-settling={settling}
            style={{ "--rotary-mark-angle": `${knobAngle}deg` }}
          >
            <span className="rotary__knob-mark">
              <span className="rotary__knob-mark-tip" />
            </span>
          </span>
        </div>
